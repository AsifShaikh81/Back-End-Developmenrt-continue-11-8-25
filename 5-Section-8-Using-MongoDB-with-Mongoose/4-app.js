//topic:86. Creating Documents and Testing the Model
...
// -----------------------main topic---------------/
//*crating document
//*syntax --> new <collectionName/modelName({...})>
...
//*use for testing purpose ,its optional 
DOCUMENT.save()
  .then((value) => {
    console.log(value);
  })
...
//!note : using then() catch() bcz DOCUMENT.save() returns promise
