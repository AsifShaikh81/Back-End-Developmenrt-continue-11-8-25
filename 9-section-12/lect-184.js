...
//in this lecture we will build tour page like we build overview page

// exolain :https://chatgpt.com/c/68c274eb-0e90-832f-840b-16728d20b5e4
//view controller
exports.getTour = (req, res) => {
  const tours = Tour.findOne({slug:req.body.params}).populate({
    path:'reviews', //Tells Mongoose: “use the virtual field reviews defined in the schema and populate it with documents from the Review model.”
...
mixins==>So mixins are basically reusable pieces of code
that we can pass arguments into.So a bit like a function.
...
block content
  section.section-header
    .header__hero
      ...
      'tour'->  comming from viewController
