...
router.route('/distances/:latlng/unit/:unit').get(TourControllersDB.getDistance);
router
  .route('/')
  .get(/* authController.protectTourRoute, */ TourControllersDB.getAllTours)
  .post(authController.protectTourRoute, authController.restrictTo('user', 'lead-guide'), TourControllersDB.postTours);
...
router
  ...
  .get(
    ...
    TourControllersDB.getMonthlyPlan,
  );
router
  .route('/:ID')
  ...
  .patch(
    authController.protectTourRoute,
    authController.restrictTo('user', 'lead-guide'),
    TourControllersDB.uploadTourImages,
    TourControllersDB.resizeTourImages,
    TourControllersDB.updateTours,
  )
  .delete(
    authController.protectTourRoute,
    authController.restrictTo('admin', 'lead-guide'),
    TourControllersDB.deleteTours,
  );
